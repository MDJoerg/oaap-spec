...
- [oaap.core.gateway](oaap.core.gateway.md) — HTTP gateway (outline, v0.2.12)
...
- [oaap.net.destinations](oaap.net.destinations.md) — named targets of a tenant an instance is bound to: HTTP through a gateway listener that knows its caller by network and adds the credential the app never sees, TCP as a handover said out loud, no bindings in a rehearsal; RFC-0033 stage 1, no connector yet (draft, v0.1)
