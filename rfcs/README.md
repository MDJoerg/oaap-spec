...
- [RFC-0041](RFC-0041-external-identity-providers.md) — External Identity Providers: Keycloak, a Realm per Tenant, and the Way Out (Accepted 2026-09-22 — all seven decisions taken; K3 manages realms through the admin API, K4 is a per-tenant policy, K7 brings self-registration and 2FA into v1; nothing built, two measurements come first)
