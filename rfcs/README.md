...
- [RFC-0041](RFC-0041-external-identity-providers.md) — External Identity Providers: Keycloak, a Realm per Tenant, and the Way Out (Accepted 2026-09-22 — all seven decisions taken; K3 manages realms through the admin API, K4 is a per-tenant policy, K7 brings self-registration and 2FA into v1; nothing built; both measurements DONE 2026-09-22 on oaap-test against Keycloak 26.7.4 — the sub survives export+import unchanged, the admin API does what K3 needs, and a realm export turned out to carry the client secret and password hashes, so it is a secret)
